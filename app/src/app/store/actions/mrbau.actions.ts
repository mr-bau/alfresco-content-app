...
export const MRBAU_SHOW_DOC_TASK_DIALOG_WINDOW = 'MRBAU_SHOW_DOC_TASK_DIALOG_WINDOW';
...
export class MrbauShowDocTaskDialogWindowAction implements Action {
  readonly type = MRBAU_SHOW_DOC_TASK_DIALOG_WINDOW;
