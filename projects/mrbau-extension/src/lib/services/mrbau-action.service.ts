...
export class MrbauActionService {
  ...
  private _actionsApi: ActionsApi | undefined;
  ...
  private _webscriptApi: WebscriptApi | undefined;
  ...
  getClassDefinition(nsp : string) : Promise<any> {
    ...
    return this.webscriptApi.executeWebScript('GET', 'api/defclasses?nsp='+nsp, null, undefined, undefined, {});
  }
  ...
  getFormDefinitionForAction(item_id:string) :Promise <any> {
    ...
    return this.webscriptApi.executeWebScript('POST', 'api/formdefinitions',null, undefined, undefined, {'itemKind' : 'action','itemId' : item_id });
  }
