...
import { TasksDetailNewDocumentComponent } from '../tasks/task-detail/task-detail-new-document/tasks-detail-new-document.component';
...
export class MRBauArchiveNodeTypeLabelPipe implements PipeTransform {
  ...
  transform(value: keyof typeof this.data): string {
    const result = this.data[value];
    return (result) ? result : value;
  }
}

@Pipe({name: 'mrbauNodeAssociationEntryFilterPipeImpure', pure: false, standalone: true})
...
export const DocumentTypeFormOptionsBase : ISelectFormOptions[] = [
  {value: 'mrba:archiveDocument', label: 'Beleg'},
]
export const DocumentTypeFormOptions : ISelectFormOptions[] = [
  {value: 'mrba:offer', label: 'Angebot'},
  {value: 'mrba:order', label: 'Auftrag'},
  {value: 'mrba:orderNegotiationProtocol', label: 'Vergabeverhandlungsprotokoll'},
  {value: 'mrba:frameworkContract', label: 'Zahlungskonditionen / Jahresauftrag'},
  ...
  {value: 'mrba:rentContract', label: 'Mietvertrag'},
  {value: 'mrba:contractCancellationWaiver', label: 'Kündigungsverzicht'},
  {value: 'mrba:maintenanceContract', label: 'Wartungsvertrag'},
  {value: 'mrba:allInContract', label: 'All-In Vertrag'},
  {value: 'mrba:licenseContract', label: 'Lizenzvertrag'},
  {value: 'mrba:financingContract', label: 'Finanzierungsvertrag'},
  {value: 'mrba:workContract', label: 'Werkvertrag'},
  {value: 'mrba:contractCancellation', label: 'Kündigung'},
  {value: 'mrba:miscellaneousContractDocument', label: 'Sonstiger Vertrag'},

  {value: 'mrba:monition', label: 'Mahnung'},
  {value: 'mrba:guarantee', label: 'Garantie'},
  {value: 'mrba:liabilityEscrow', label: 'Haftrücklass'},
  {value: 'mrba:financialRetention', label: 'Deckungsrücklass'},
  {value: 'mrba:contractGuarantee', label: 'Erfüllungsgarantie'},
  {value: 'mrba:noteDocument', label: 'Bescheid'},
];
...
export interface IMRBauDocumentType {
  ...
  mrbauWorkflowDefinition: {
    states: IMRBauWorkflowState[] | null
  }
}
...
export class MrbauArchiveModel {
  ...
  getDocumentCategoryFromName(name:string) : EMRBauDocumentCategory | null {
  ...
  getWorkFlowStateFromNodeType(data:MRBauWorkflowStateCallbackData) : IMRBauWorkflowState | null {
    if (data.taskDetailNewDocument.task == null || data.taskDetailNewDocument.taskNode == null) {
      return null;
    }
  ...
  readonly mrbauBelege : IMRBauDocumentType[] = [
      ...
      mrbauWorkflowDefinition: {states : [
        ...
        {state : EMRBauTaskStatus.STATUS_FORMAL_REVIEW,
          nextState : (data) => new Promise<IMRBauTaskStatusAndUser>((resolve, reject) => {
            ...
            this.mrbauWorkflowService.recalculateDueDate(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_FORMAL_REVIEW)
            .then ( (result) => {
              result;
              return this.mrbauWorkflowService.getNewUserWithDialog(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_INVOICE_VERIFICATION)
            })
            .then( (userName) => {
        ...
        {state : EMRBauTaskStatus.STATUS_INVOICE_VERIFICATION,
          nextState : (data) => new Promise<IMRBauTaskStatusAndUser>((resolve, reject) => {
            this.mrbauWorkflowService.recalculateDueDate(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_INVOICE_VERIFICATION)
            .then ( (result) => {
              result;
          ...
          onEnterAction : (data) => this.mrbauWorkflowService.invoiceVerificationPrefillValues(data as MRBauWorkflowStateCallbackData)
        },

        {state : EMRBauTaskStatus.STATUS_INVOICE_REVIEW,
          nextState : (data) => new Promise<IMRBauTaskStatusAndUser>((resolve, reject) => {
            this.mrbauWorkflowService.getNewElevatedUserWithDialog(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_FINAL_APPROVAL)
        ...
        {state : EMRBauTaskStatus.STATUS_FINAL_APPROVAL,
          nextState : (data) => new Promise<IMRBauTaskStatusAndUser>((resolve, reject) => {
            this.mrbauWorkflowService.getNewUserWithDialog(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_ACCOUNTING)
    ...
    },
    {
      ...
      mrbauWorkflowDefinition: {states : [
        ...
        {state : EMRBauTaskStatus.STATUS_FORMAL_REVIEW,
          nextState : (data) => new Promise<IMRBauTaskStatusAndUser>((resolve, reject) => {
            this.mrbauWorkflowService.getNewUserWithDialog(data as MRBauWorkflowStateCallbackData, EMRBauTaskStatus.STATUS_INVOICE_VERIFICATION)
            .then( (userName) => {
  ...
  readonly CONTRACT_DEFAULT_WORKFLOW_DEFINITION : {states: IMRBauWorkflowState[] | null} = {
    states : [
      {state : EMRBauTaskStatus.STATUS_METADATA_EXTRACT_1,
        nextState : () => new Promise<IMRBauTaskStatusAndUser>(resolve => resolve({state:EMRBauTaskStatus.STATUS_METADATA_EXTRACT_2})),
        prevState : () => new Promise<IMRBauTaskStatusAndUser>(resolve => resolve({state:EMRBauTaskStatus.STATUS_METADATA_EXTRACT_1}))},
  ...
  readonly mrbauContracts : IMRBauDocumentType[] = [
    {
      ...
      folder: "-",
      group : DocumentCategoryGroups.get(EMRBauDocumentCategoryGroup.CONTRACTS) as IDocumentCategoryGroupData,
      mrbauFormDefinitions : null,
      mrbauWorkflowDefinition: {states : null},
    },
    {
