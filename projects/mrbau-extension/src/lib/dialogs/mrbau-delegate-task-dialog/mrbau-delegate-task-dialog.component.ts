...
@Component({
  ...
  selector: 'mrbau-delegate-task-dialog',
  template: `
...
export class MrbauDelegateTaskDialogComponent extends MrbauBaseTaskDialogComponent implements OnInit {
  override dialogTitle: string = 'Aufgabe delegieren';
  override dialogMsg: string = 'Aufgabe einer anderen Person übertragen.';
  override dialogButtonCancel: string = 'ABBRECHEN';
  override dialogButtonOK: string = 'DELEGIEREN';

  constructor(
    private mrbauFormLibraryService : MrbauFormLibraryService,
    public override  dialogRef: MatDialogRef<MrbauDelegateTaskDialogComponent>,
